public static class UniqueLetters {
    ...
    private static bool AreUniqueLetters(string text) {
        ...
        //     }
        // }
        HashSet<char> checkingSet = []; // or var checkingSet = new HashSet<char>();
        foreach (char a in text)
        {
            if (checkingSet.Contains(a))
            {
                return false;
            }
            checkingSet.Add(a);
        }
        // Other solution given: loop through string, put into set, compare sizes
