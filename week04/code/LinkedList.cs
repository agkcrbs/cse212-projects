...
public class LinkedList : IEnumerable<int>
{
    ...
    public void RemoveHead()
    {
        ...
        // cover an empty list.  It's fine to set to null again.
        if (_head == _tail)
        {
            _head = null;
            _tail = null;
        ...
        // TODO Problem 3
        {
            ...
            while (curr is not null)
            {
                if (curr.Data == value)
                {
                    ...
                    // For any other location of 'value', need to 
                    // reconnect the links to remove.
                    else
                    {
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        while (curr is not null)
        {
            ...
            {
                // If the location of 'oldValue' matches the current node, 
                // replace the node's data with 'newValue'
                curr.Data = newValue;
            }
